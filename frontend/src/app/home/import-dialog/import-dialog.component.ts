import { AfterViewInit, Component, OnInit, ChangeDetectorRef, ViewChild, ViewChildren, SimpleChanges, OnChanges } from '@angular/core';
...
export class ImportDialogComponent implements AfterViewInit, OnChanges
{
    ...
    constructor(public dialogRef: MatDialogRef<ImportDialogComponent>, private importService: ImportService,
