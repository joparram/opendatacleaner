...
class ExporterController(Resource):
    ...
    def get(self):
        ...
        dataPlugins: ExporterPlugins = _v1._private.container[ExporterPlugins]
    ...
    def post(self):
        ...
        result = send_file(data['file'], as_attachment=True,
