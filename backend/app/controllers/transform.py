from ..api import _v1
from ..components.transform import componentName
from flask import session, render_template, request, redirect, url_for
from flask_restful import Resource, Api
from app.components._components import Components
from app.components._plugins import TransformPlugins
from app.error import Error
from flask_jsonpify import jsonify
from app.utils.encoders import dataclassToJson

class TransformController(Resource):
    def __init__(self):
        print("__init__")
    ...
    def get(self): 
        ...
        dataPlugins: TransformPlugins = _v1._private.container[TransformPlugins]
    ...
    def post(self):
        data = None
        components: Components = _v1._private.container[Components]
        plugins: Components = _v1._private.container[TransformPlugins]
